...
class NewAddSubCompanyScree extends StatefulWidget {
  const NewAddSubCompanyScree(
      {super.key, required this.strSubCompanyName, this.getMainCompantData});

  final getMainCompantData;
  final String strSubCompanyName;

  @override
  State<NewAddSubCompanyScree> createState() => _NewAddSubCompanyScreeState();
}

class _NewAddSubCompanyScreeState extends State<NewAddSubCompanyScree> {
  //
...
//
  ...
  funcAddSubCompany(
    ...
    CollectionReference users = FirebaseFirestore.instance.collection(
      '${strFirebaseMode}company/${widget.getMainCompantData['company_firebase_id'].toString()}/sub_company',
    );
        ...
        .add(
          {
            ...
            'company_id': widget.getMainCompantData['company_id'].toString(),
            'company_firebase_id':
  ...
  funcEditFirestoreIdInRegistration(elementId) {
    FirebaseFirestore.instance
      ...
      (value) {
        ...
        //
        // print('DONE CREATE SUB COMPANY and ALL DONE');
